...
<body>
    ...
    <section class="categories">
        <div class="category">
            ...
            <a href="../html/sports.html" class="btn">View Sports Trainers</a>
        </div>
        ...
        <div class="category">
            ...
            <a href="../html/music.html" class="btn">View Music Trainers</a>
        </div>
        ...
        <div class="category">
            ...
            <a href="../html/education.html" class="btn">View Education Trainers</a>
        </div>
    </section>
</body>
</html>