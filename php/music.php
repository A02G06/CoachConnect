<!-- filepath: c:\wamp64\www\CoachConnect\php\music.php -->
<?php
// Database connection
...
// Fetch only music trainers from the database
$query = "SELECT trainer_id, name, expertise, phone, email FROM trainers WHERE category = 'music'";
...
<head>
    ...
    <title>Music Trainers</title>
    <link rel="stylesheet" href="../css/music.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
</head>
<body>
    <header class="header-banner" style="background-image: url('../img/musicbg.jpg');">
        <div class="header-content">
            <h1>Music Trainers</h1>
            <p>Find the best Coach for your musical needs!</p>
        </div>
    </header>
    ...
    <section class="trainers-section">
        ...
        <div class="trainers-container">
            ...
            <?php
                ...
                echo "<p>No music trainers found.</p>";
            }
            ?>
        </div>
    </section>
